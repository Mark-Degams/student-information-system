...
def generate_program_college():
    ...
    programs = [
        ...
        ["CBAAZ","BSA","BACHELOR OF SCIENCE IN ACCOUNTANCY"],
        ["CBAAZ","BSBA-BE","BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATION (BUSINESS ECONOMICS)"],
        ["CBAAZ","BSBA-EM","BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATION (ENTREPRENEURIAL MARKETING)"],
        ["CBAAZ","BSBA-Econ","BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATION (ECONOMICS)"],
        ["CBAAZ","BSHRM","BACHELOR OF SCIENCE IN HOTEL AND RESTAURANT MANAGEMENT"],
